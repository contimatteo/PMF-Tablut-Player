...
class MinMaxAlgorithm():
    max: str = "white"  # TODO: non bisogna assegnarli in base al ruolo del nostro giocatore ?
    min: str = "black"  # TODO: non bisogna assegnarli in base al ruolo del nostro giocatore ?
